            ...
            <div class="col-lg-6">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url(); ?>dashboa/proses_update" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <br>
                                        ...
                                        <input type="file" value="<?= $photo; ?>" name="image" id="image" class="form-control-file">
                            ...
                            <div class="form-group">
                                ...
                                <select value="<?= $level; ?>" class="form-select" aria-label="Default select example" id="level" name="level">
